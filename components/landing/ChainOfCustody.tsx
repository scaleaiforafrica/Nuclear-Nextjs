    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-primary text-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 sm:mb-12 lg:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-3 sm:mb-4">Chain of Custody Management</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
          {/* Blockchain Storage */}
          <div className="bg-card/10 backdrop-blur-sm rounded-lg p-5 sm:p-6 lg:p-8 border border-white/20">
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-white/10 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              <Database className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" />
            </div>
            <h3 className="font-heading text-lg sm:text-xl lg:text-2xl mb-2 sm:mb-3">Blockchain Storage</h3>
          ...
          <div className="bg-card/10 backdrop-blur-sm rounded-lg p-5 sm:p-6 lg:p-8 border border-white/20">
            ...
            <h3 className="font-heading text-lg sm:text-xl lg:text-2xl mb-2 sm:mb-3">Instant Verification</h3>
            <p className="text-white/80 text-sm sm:text-base">
          ...
          <div className="bg-card/10 backdrop-blur-sm rounded-lg p-5 sm:p-6 lg:p-8 border border-white/20 sm:col-span-2 lg:col-span-1">
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-white/10 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              <Shield className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" />
            </div>
            <h3 className="font-heading text-lg sm:text-xl lg:text-2xl mb-2 sm:mb-3">Full Compliance</h3>
            <p className="text-white/80 text-sm sm:text-base">
        ...
        <div className="mt-10 sm:mt-12 lg:mt-16 max-w-4xl mx-auto">
          <div className="bg-card/10 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/20">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
              <h4 className="text-lg sm:text-xl">Live Custody Timeline</h4>
              <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-green-500/20 text-green-400 rounded-full text-xs sm:text-sm w-fit">Active</span>
            </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                {[
                  ...
                  <div key={index} className="relative pl-10 sm:pl-12 flex items-start sm:items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-2 mb-1">
                        <span className="text-xs sm:text-sm text-gray-400">{item.time}</span>
                        <span className="text-xs sm:text-sm text-gray-500">{item.user}</span>
                      </div>
