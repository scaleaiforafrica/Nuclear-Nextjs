      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-4 sm:mb-6 text-foreground">
          ...
          <div className="space-y-4 sm:space-y-6">
            {/* Certifications Grid */}
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 border border-green-200">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <Award className="w-6 h-6 sm:w-7 sm:h-7 text-green-600" />
                <h3 className="text-xl sm:text-2xl">Certifications</h3>
              </div>
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                {certifications.map((cert, index) => (
                  <div key={index} className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-green-200 text-center hover:scale-[1.02] transition-transform">
            ...
            {/* Compliance Score */}
            <div className="bg-gray-900 text-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8">
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                <h3 className="text-xl sm:text-2xl">Compliance Score</h3>
              ...
              <div className="flex items-end gap-2 sm:gap-4 mb-3 sm:mb-4">
                ...
                <div className="text-xl sm:text-2xl text-gray-400 mb-1 sm:mb-2">/100</div>
              </div>
              <div className="w-full bg-gray-800 rounded-full h-2.5 sm:h-3 mb-3 sm:mb-4">
                <div className="bg-gradient-to-r from-green-400 to-blue-500 h-2.5 sm:h-3 rounded-full" style={{ width: '100%' }}></div>
              </div>
              <p className="text-gray-400 text-sm sm:text-base">All regulatory requirements met</p>
            </div>

            {/* Alert System */}
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 border border-orange-200">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <AlertTriangle className="w-6 h-6 sm:w-7 sm:h-7 text-orange-600" />
                <h3 className="text-xl sm:text-2xl">Proactive Monitoring</h3>
              </div>
