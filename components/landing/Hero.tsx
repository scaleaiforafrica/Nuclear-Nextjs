      ...
      <div className="relative min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 overflow-hidden">
        ...
        <nav className="container mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-gray-700 hover:text-purple-600 transition-colors">Platform</a>
            <a href="#analytics" className="text-gray-700 hover:text-purple-600 transition-colors">Solutions</a>
            <a href="#chain-of-custody" className="text-gray-700 hover:text-purple-600 transition-colors">Resources</a>
            <a href="#quality-compliance" className="text-gray-700 hover:text-purple-600 transition-colors">Company</a>
          </div>
          <button 
            onClick={onOpenLogin}
