    ...
    <div className="flex h-screen bg-[#1F1F1F] overflow-hidden">
      ...
      {isDemo && <DemoBanner />}
        ...
        <aside 
          ...
          } w-[280px] max-w-[85vw] bg-[#2A2A2A] border-r border-[#3A3A3A] flex flex-col transition-all duration-300 ease-out
        ...
        >
        {/* Logo */}
        <div className="h-16 flex items-center px-4 sm:px-6 border-b border-[#3A3A3A]">
          ...
          <button
            onClick={closeMobileMenu}
            className="lg:hidden p-2 hover:bg-[#3A3A3A] rounded-lg touch-manipulation min-w-[44px] min-h-[44px] flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  ...
                  <Link
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-lg transition-all relative touch-manipulation min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset ${
                      isActive
                        ...
                        : 'text-gray-300 hover:bg-[#3A3A3A] active:bg-[#404040]'
                    }`}
        ...
        <div className="border-t border-[#3A3A3A] mt-auto">
          <Link
          ...
          <div className={`${sidebarCollapsed ? 'p-2' : 'p-3 sm:p-4'} border-t border-[#3A3A3A] safe-area-inset-bottom`}>
            <div className="mb-3">
              <ProfileSwitcher
                currentProfile={{
                  name: userName,
            ...
            {!sidebarCollapsed && (
              <button 
                ...
                className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:bg-[#3A3A3A] active:bg-[#404040] rounded-lg transition-colors touch-manipulation min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
        ...
        <button
          ...
          className="hidden lg:flex absolute top-20 -right-3 w-6 h-6 bg-[#2A2A2A] border border-[#3A3A3A] rounded-full items-center justify-center hover:bg-[#3A3A3A] transition-colors z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        {/* Content Area */}
        <main className="flex-1 overflow-auto bg-[#1F1F1F] touch-scroll">
