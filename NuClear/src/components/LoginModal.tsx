      ...
      <div className="bg-white rounded-3xl max-w-md w-full shadow-2xl relative animate-in slide-in-from-bottom-4 duration-300">
        ...
        <form onSubmit={handleSubmit} className="px-8 pb-8">
          <div className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all hover:scale-[1.02] active:scale-100"
            >
