    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <button
          ...
          className="absolute top-20 -right-3 w-6 h-6 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors"
        >
